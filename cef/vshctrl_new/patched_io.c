...
int umdemuloadexec(char * file, struct SceKernelLoadExecVSHParam * param) {
	...
	static int apitypes[2][2] = {
		{SCE_EXEC_APITYPE_DISC_EMU_MS1, SCE_EXEC_APITYPE_DISC_EMU_MS2},
		{SCE_EXEC_APITYPE_DISC_EMU_EF1, SCE_EXEC_APITYPE_DISC_EMU_EF2}
	};
...
int umdLoadExec(char * file, struct SceKernelLoadExecVSHParam * param) {
	...
	if(psp_model == PSP_GO) {
		char devicename[20];
		int apitype = SCE_EXEC_APITYPE_DISC_EMU_MS1;
